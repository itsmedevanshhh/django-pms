...
class developerlogin(LoginView):
    template_name = "user/developerlogin.html"
...
class ManagerPage(ListView):            
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, './managerpage.html',{
            'projects':project,'labels':labels,'data':data
        })
...
class DeveloperPage(ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, './developerpage.html', {
            'projects': project,
        })
...
class AboutUs(ListView):
    ...
    template_name = 'templates/aboutus.html'
